...
@section('body')
            ...
            <x-container class="mb-6">
                <div class="flex flex-col gap-6">
                    <div class="flex flex-col items-start gap-6">
                        <x-eyebrow>Reference</x-eyebrow>
                        <h1 class="text-balance text-zinc-950 dark:text-white font-black text-5xl sm:text-6xl m-0 leading-[1.05] tracking-tight max-w-4xl agent:max-w-none">The format, in full.</h1>
    ...
    <div class="bg-zinc-200 dark:bg-zinc-700 pt-8">
        ...
        <x-section>
            <x-slot name="eyebrow">
                <x-eyebrow>Frontmatter Fields</x-eyebrow>
            </x-slot>
            The fields.
        </x-section>
